    ...
    void callAPI(String question) {
        ...
        if (userInfo != null) {
            promptBuilder.append(" The user is on a ")
                    ...
                    .append(" regimen. Their daily nutritional goal is ")
                    .append(userInfo.getDailyCalorie())
                    .append(" calories. They have currently consumed ")
                    .append(userInfo.getCurrentCalorie())
                    .append(" calories. Please recommend a menu item from the list: ")
        ...
        /* 채팅 로직 일단 수정..차후 세세하게 변경예정.
        .append(" Their daily nutritional goals are ")
